...
var bg_glass = ["x1", "x2", "x3", "x4", "x5", "x6", "x7"];
for (let bg = 0; bg < bg_glass.length; bg++) {
    let r = ".bg-glass-" + bg_glass[bg];
    if ($(r)[0]) {
        var b = r.replace(".bg-glass-x", "");
        $(r).css({ background: "rgba(0, 0, 0, 0." + b + "0)", "backdrop-filter": "blur(6.3px)", "-webkit-backdrop-filter": "blur(6.3px)", border: "1px solid rgba(50, 55, 66, 0.10)" });
    }
}
...
for (let ex = 0; ex < bg_class.length; ex++) {
    if ($(".primary" + bg_limit[ex])[0]) {
        ...
        let e = l.replace(/[^0-9\/]/g, "");
        $(l).css({ background: " rgba(2, 104, 212, 0." + e + "0)", "backdrop-filter": "blur(6.3px)", "-webkit-backdrop-filter": "blur(6.3px)", border: "1px solid rgba(50, 55, 66, 0.10)" });
    }
    if ($(".success" + bg_limit[ex])[0]) {
        var l = ".success" + bg_limit[ex];
        let a = l.replace(/[^0-9\/]/g, "");
        $(l).css({ background: " rgba(46, 147, 42, 0." + a + "0)", "backdrop-filter": "blur(6.3px)", "-webkit-backdrop-filter": "blur(6.3px)", border: "1px solid rgba(50, 55, 66, 0.10)" });
    }
    if ($(".danger" + bg_limit[ex])[0]) {
        var l = ".danger" + bg_limit[ex];
        let i = l.replace(/[^0-9\/]/g, "");
        $(l).css({ background: " rgba(220, 53, 69, 0." + i + "0)", "backdrop-filter": "blur(6.3px)", "-webkit-backdrop-filter": "blur(6.3px)", border: "1px solid rgba(50, 55, 66, 0.10)" });
    }
    if ($(".warning" + bg_limit[ex])[0]) {
        var l = ".warning" + bg_limit[ex];
        let g = l.replace(/[^0-9\/]/g, "");
        $(l).css({ background: " rgba(255, 193, 7, 0." + g + "0)", "backdrop-filter": "blur(6.3px)", "-webkit-backdrop-filter": "blur(6.3px)", border: "1px solid rgba(50, 55, 66, 0.10)" });
    }
    if ($(".info" + bg_limit[ex])[0]) {
        var l = ".info" + bg_limit[ex];
        let s = l.replace(/[^0-9\/]/g, "");
        $(l).css({ background: " rgba(23, 162, 184, 0." + s + "0)", "backdrop-filter": "blur(6.3px)", "-webkit-backdrop-filter": "blur(6.3px)", border: "1px solid rgba(50, 55, 66, 0.10)" });
    }
    if ($(".dark" + bg_limit[ex])[0]) {
        var l = ".dark" + bg_limit[ex];
        let t = l.replace(/[^0-9\/]/g, "");
        $(l).css({ background: " rgba(0, 0, 0, 0." + t + "0)", "backdrop-filter": "blur(6.3px)", "-webkit-backdrop-filter": "blur(6.3px)", border: "1px solid rgba(50, 55, 66, 0.10)" });
    }
    if ($(".light" + bg_limit[ex])[0]) {
        var l = ".light" + bg_limit[ex];
        let x = l.replace(/[^0-9\/]/g, "");
        $(l).css({ background: " rgba(255, 255, 255, 0." + x + "0)", "backdrop-filter": "blur(6.3px)", "-webkit-backdrop-filter": "blur(6.3px)", border: "1px solid rgba(50, 55, 66, 0.10)" });
    }
}
